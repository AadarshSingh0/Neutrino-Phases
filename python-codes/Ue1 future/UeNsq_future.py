...
base_path = "/home/as/Downloads/neutrino data/data_ue1_fut/data"
...
plt.text(8.25-9, -10.4, r'$\mathrm{DUNE} $',fontsize=16,rotation=0,color='navy')
...
plt.text(4.5-9, -9.8, r'$\mathrm{HUNTER}$',fontsize=16,rotation=0,color='mediumvioletred')
